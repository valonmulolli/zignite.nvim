...
require("integration.detect.tooling.picker")
require("integration.detect.tooling.parsers")
require("integration.detect.tooling.commands")
require("integration.detect.tooling.package_json")
